...
// //           final isVoice = _isValidAudio(base64Chunk);
...
// //     final rms = sqrt(energy / bytes.length);
// //     return rms > 500;
// //   }

// //   /// ➕ ADD AI AUDIO
// //   void addAudioChunk(String base64Chunk) {
// //     _audioBuffer.add(base64Decode(base64Chunk));
// //   }

// //   /// 🔊 PLAY AI AUDIO
// //   Future<void> playBufferedAudio() async {
// //     if (_audioBuffer.isEmpty || _isBusy) return;
...
// //       final sub = _player.onPlayerComplete.listen((event) {
// //         completer.complete();
// //       });
